  ...
  return (
    <div className="page-fade">
      <div className="stats-grid">
        <StatCard label="Insumos Cadastrados" value="24" sub="3 abaixo do mínimo"  icon="🌾" color="vinho"   />
        <StatCard label="Produtos no Estoque" value="18" sub="6 tipos de produto"  icon="📦" color="terra"   />
        <StatCard label="Produção Hoje"        value="47" sub="unidades produzidas" icon="🏭" color="verde"   />
        <StatCard label="Vencimentos Próximos" value="5"  sub="nos próximos 3 dias" icon="⏰" color="amarelo" />
      </div>
      ...
      <div className="dash-grid">
        ...
        {/* Produtos acabados */}
        <div className="dash-panel">
          <h4>📦 Estoque de Produtos Acabados</h4>
        ...
        {/* Nível dos insumos */}
        <div className="dash-panel">
          <h4>🌾 Nível dos Insumos Principais</h4>
